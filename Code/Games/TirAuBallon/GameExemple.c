...
void TAB_Update(PGAME _pExemple)
{
    ...
    {
        pGameData->mouse.x = _pExemple->pEvent->mouse.x*(_pExemple->SampleAlManager->ResolutionScale);
        pGameData->mouse.y = _pExemple->pEvent->mouse.y*(_pExemple->SampleAlManager->ResolutionScale);
    }
