...
typedef struct _ALLEGRO_SAMPLES
{
    ...
    ALLEGRO_SAMPLE *FBMenu;
    ALLEGRO_SAMPLE *FBGame;
    ALLEGRO_SAMPLE *FBDeath;
...
typedef struct _ALLEGRO_SAMPLES_INSTANCE
{
    ...
    ALLEGRO_SAMPLE_INSTANCE *FBMenu;
    ALLEGRO_SAMPLE_INSTANCE *FBGame;
    ALLEGRO_SAMPLE_INSTANCE *FBDeath;
